...
function Ajanijahernoticlastpublishedate({ route, navigation }) {
  // 0
  ...
  const tableData = () => {
    ...
    //     if (isUserActive) {
    //       NavigationService.navigate('AjanijahernoticLastPublishe');
    //     } else {
    ...
    (async () => {
      ...
      setRefreshing(false);
      fetch(
        `https://qaapi.jahernotice.com/api2/app/ajanijahernotice/dashboard/${Userid}/${Date}`,
      )
...
export default Ajanijahernoticlastpublishedate;
