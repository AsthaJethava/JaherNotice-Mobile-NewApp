...
const Viewcom = ({ route, navigation }) => {
  ...
  //     if (isUserActive) {
  //       NavigationService.navigate('AuctionServiceCount');
  //     } else {
  ...
  const tableData = async () => {
    ...
    try {
      const response = await fetch(
        `https://qaapi.jahernotice.com/api2/getAuctionNotice/ByUserID/${Userid}?PageSize=${PageNumber}&PageNo=${currentPage}&Dayif=${selectedDat}`,
        {
          method: 'GET',
          headers: myHeaders,
          redirect: 'follow',
                      ...
                      >
                                ...
                                <Text
                                  ...
                                  onPress={() =>
                                    navigation.navigate(
                                      ...
                                      {
                                        imagepepar: item.Imagepath,
                                        Notice_Date: formatDate(
                                          item.NotificationDate,
                                        ),
                                        notifyby: item.NewspaperName,
                                        imagedownlod: item.Imagepath,
                        ...
                        <View style={style.containerma}>
                          ...
                          <View style={style.VewText}>
                            ...
                            >
                              Auction Type :{' '}
                              <Text style={style.textD}>{item.NoticeType}</Text>
                            </Text>
                          </View>
                          <Divider style={style.ViewT} />
                          <View style={style.VewText}>
                            ...
                            >
                              Survey No. :{' '}
                              <Text style={style.textD}>{item.SurveyNo}</Text>
                            </Text>
                          </View>
                          <Divider style={style.ViewT} />
                          <View style={style.VewText}>
                          ...
                          <View style={style.VewText}>
                            ...
                            >
                              FP No. :{' '}
                              <Text style={style.textD}>{item.FPNo}</Text>
                            </Text>
                          </View>
                          <Divider style={style.ViewT} />
                          <View style={style.VewText}>
                            ...
                            >
                              Building No. :{' '}
                              <Text style={style.textD}>{item.BuildingNo}</Text>
                            </Text>
                          </View>
                          <Divider style={style.ViewT} />
                          <View style={style.VewText}>
